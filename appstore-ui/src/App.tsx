...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "Inter, system-ui, Arial", padding: 16, maxWidth: 1400, margin: "0 auto" }}>
      ...
      {tab === "weekly" && (
        <div>
          <h3>WEEKLY INSIGHTS — <span style={{ fontWeight: 400 }}>(Week of {formatWeekRange(weeklyStart, weeklyEnd)})</span></h3>
          <div style={{ marginBottom: 8, color: "#555" }}>
            Showing: <b>{weeklyStatus === "all" ? "All" : weeklyStatus}</b>
            {weeklyCounts && (
              <span style={{ marginLeft: 12 }}>
                NEW: <b>{weeklyCounts.NEW}</b> • RE-ENTRY: <b>{weeklyCounts.RE_ENTRY}</b>
              </span>
            )}
          </div>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid #eee" }}>
              ...
              <tbody>
                {weeklyRows.length === 0 && (
                  <tr><td colSpan={5} style={{ padding: 8, textAlign: "center", color: "#777" }}>No data for selected filters.</td></tr>
                )}
